...
const CrewsList = () => {
  ...
  return (
    <div className="crews-container" style={{ padding: '2rem', maxWidth: 900, margin: '0 auto' }}>
      <h2 className="crews-title" style={{ textAlign: 'center', marginBottom: '2rem', fontSize: '2rem', fontWeight: 700 }}>
      🚀 Available AI Crews
      </h2>
      <div className="crews-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '1.5rem' }}>
